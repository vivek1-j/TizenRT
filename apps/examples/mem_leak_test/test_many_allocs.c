...
void test_many_allocs(void)
{
	...
	printf("  ┌─────────────────────────────────────────────────────┐\n");
	printf("  │ STEP 1: All %d blocks reachable via BSS array        │\n", D2_COUNT);
	...
	g_ptr_array[50] = NULL;
	printf("  Cleared g_ptr_array[50] = NULL\n");
	printf("  Block is now orphaned (no references).\n");
	printf("\n");

	printf("  ┌─────────────────────────────────────────────────────┐\n");
	printf("  │ STEP 2: All references cleared — 1 block leaked      │\n");
	printf("  │ EXPECTED: v1 1 LEAK, v2 1 LEAK                      │\n");
	printf("  └─────────────────────────────────────────────────────┘\n");
	printf("\n");
