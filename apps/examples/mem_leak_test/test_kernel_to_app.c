...
void test_kernel_to_app(void)
{
	...
	printf("  ┌─────────────────────────────────────────────────────┐\n");
	printf("  │ STEP 1: Block reachable via kernel MQ                 │\n");
	printf("  │ EXPECTED: v1 NO LEAK, v2 NO LEAK                     │\n");
	printf("  └─────────────────────────────────────────────────────┘\n");
	printf("\n");
	printf("  >>> Run both tools from TASH: <<<\n");
	...
	printf("  ┌─────────────────────────────────────────────────────┐\n");
	printf("  │ STEP 2: MQ closed — block is now leaked              │\n");
	printf("  │ EXPECTED: v1 may miss (stale ptr), v2 may miss       │\n");
	printf("  │ (stale pointer limitation — see test results doc)    │\n");
	printf("  └─────────────────────────────────────────────────────┘\n");
	printf("\n");
	printf("  >>> Run both tools again from TASH: <<<\n");
	printf("  TASH> mem_leak\n");
	printf("  TASH> mem_leak_v2\n");
	printf("\n");
